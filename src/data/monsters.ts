...
export const MONSTERS: Monster[] = [
  ...
  { id: 'dark-assassin', name: 'The Dark Assassin', zoneId: 'everfrost', lvlMin: 25, lvlMax: 30, kind: 'named', where: 'Roams the tundra paths', notes: 'A silent killer of low-level travelers — the terror of Everfrost newbies.' },
  ...
  { id: 'ice-giants', name: 'Ice giants', zoneId: 'permafrost', lvlMin: 30, lvlMax: 37, kind: 'notable', where: 'Giant halls before Vox', loot: ['Fat coin drops'], notes: 'Classic platinum farming for groups in their 30s.' },
  ...
  { id: 'king-tranix', name: 'King Tranix', zoneId: 'nagafens-lair', lvlMin: 45, lvlMax: 48, kind: 'named', where: 'Fire giant throne room', loot: ['Giant-forged arms'], notes: 'Ruler of the fire giants guarding Nagafen’s door.' },
  ...
  { id: 'ghoul-assassin', name: 'A ghoul assassin', zoneId: 'lower-guk', lvlMin: 40, lvlMax: 44, kind: 'named', where: 'Assassin’s alcove', loot: ['Guise of the Deceiver (dark elf illusion mask)'], notes: 'The illusion mask is one of the most beloved rares in the game.' },
